...
<form action="facultypage.php" method="post" class="d-none">
...
<!-- <form action="facultypage.php" method="post"> -->
    <div align="center" style="margin-top: 10px ; display:none">
                ...
                <td style=\"text-align:center\">{$row['period3']}</td>
                 <td style=\"text-align:center\">{$row['period4']}</td>
                  ...
                  <td style=\"text-align:center\">{$row['period6']}</td>
                    ...
                    echo '</table>';
                    $sign = "GENERATED VIA TIMETABLE MANAGEMENT SYSTEM, INFORMATION TECHNOLOGY, CUSAT.";
