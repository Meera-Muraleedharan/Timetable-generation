...
<div class="navbar navbar-inverse navbar-fixed-top " id="menu">
    ...
    <div class="container">
        <div align="center">
            <h3 align="center">TIME TABLE MANAGEMENT SYSTEM, INFORMATION TECHNOLOGY,CUSAT</h3>
        </div>
    </div>
</div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">PROF. DIPAK KUMAR </h3>
                    <hr/>
                    <h4 align="center">PRINCIPAL<br/>SCHOOL OF ENGINEERING</h4>
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">PROF. DELISHA</h3>
                    <hr/>
                    <h4 align="center">HOD<br/> INFORMATION TECHNOLOGY DEPARTMENT</h4>
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.6s">
                <div class="faculty-div">
                    ...
                    <hr/>
                    <h4 align="center">CHAIRMAN<br/>INFORMATION TECHNOLOGY</h4>
    ...
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <div>
                ...
                <h4>India</h4>
                <h4><strong>Call:</strong> 2700920, 2400921 Ext.0487</h4>
                <h4><strong>Email: </strong>itcusat@gmail.com</h4>
            </div>
